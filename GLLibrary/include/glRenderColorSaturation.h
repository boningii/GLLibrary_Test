/*************************************************************************
 * FILENAME :        glRenderSaturation.h
 *
 * DESCRIPTION :
 *       Implement the Saturation adjustment Render Class for GLLibrary.
 *
 * NOTES :
...
#ifndef __GL_RENDER_SATURATION_H__
#define __GL_RENDER_SATURATION_H__
...
//************************************************
// Render 的 Saturation 子类。
//************************************************
class Saturation : public GLRender
{
 public:
    //-------------------------
    // 构造&析构函数。
    ...
    int32_t Draw(float saturation_rate);
    int32_t ReadOutData();
 ...
 private:
    ...
    GLint       saturation_rate_loc_;  // Saturation Rate location
