 ...
 *
 * DESCRIPTION :
 *       Implement the Box Scale Render Class for GLLibrary.
 *
 * NOTES :
...
#ifndef __GL_RENDER_BOX_SCALE_H__
#define __GL_RENDER_BOX_SCALE_H__
...
//************************************************
// Render 的 Box Scale 子类。
//************************************************
class BoxScale : public GLRender
{
 public:
    //-------------------------
    // 构造&析构函数。
