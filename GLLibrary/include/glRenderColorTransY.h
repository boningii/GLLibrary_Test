/*************************************************************************
 * FILENAME :        glRenderTransY.h
 *
 * DESCRIPTION :
 *       Implement the Trans Y Render Class for GLLibrary.
 *
 * NOTES :
...
#ifndef __GL_RENDER_TRANS_Y_H__
#define __GL_RENDER_TRANS_Y_H__
...
//************************************************
// Render 的 Transition Y 子类。
//************************************************
class TransY : public GLRender
{
 public:
    //-------------------------
    // 构造&析构函数。
