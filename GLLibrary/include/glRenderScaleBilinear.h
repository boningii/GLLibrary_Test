 ...
 *
 * DESCRIPTION :
 *       Implement the Bilinear Scale Render Class for GLLibrary.
 *
 * NOTES :
...
#ifndef __GL_RENDER_BILINEAR_SCALE_H__
#define __GL_RENDER_BILINEAR_SCALE_H__
...
//************************************************
// Render 的 Bilinear Scale 子类。
//
// Bilinear interpolation interpolation
//************************************************
class BilinearScale : public GLRender
{
 public:
    //-------------------------
    // 构造&析构函数。
...
#endif  // __GL_RENDER_BILINEAR_SCALE_H__
