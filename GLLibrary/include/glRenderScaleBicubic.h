 ...
 *
 * DESCRIPTION :
 *       Implement the Bicubic Scale Render Class for GLLibrary.
 *
 * NOTES :
...
#ifndef __GL_RENDER_BICUBIC_SCALE_H__
#define __GL_RENDER_BICUBIC_SCALE_H__
...
//************************************************
// Render 的 Bicubic Scale 子类。
//
// Bicubic interpolation interpolation
//************************************************
class BicubicScale : public GLRender
{
 public:
    //-------------------------
    // 构造&析构函数。
